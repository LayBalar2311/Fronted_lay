  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full bg-white p-2 flex items-center justify-center shadow-md z-20">
      <ul className="flex justify-between w-full max-w-md mx-auto">
            ...
            {({ isActive }) => (
              ...
              >
                <div className="relative inline-block w-5 h-5">
                  ...
                  <Percent
                    className="w-2.5 h-2.5 text-blue-500 absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2"
                  />
                </div>
               Offers
              </span>
        ...
        <li className="flex-1 text-center">
          <NavLink to="/profile" className="flex flex-col items-center text-[10px]">
            {({ isActive }) => (
              <span
                className={`flex flex-col items-center gap-0.5 ${
                  isActive ? "text-blue-500" : "text-gray-400"
